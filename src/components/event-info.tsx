...
export const EventInfo: FC<{
        ...
        return (
                ...
                >
                        {props.showTitle && <Heading size={state.isMobile ? "md" : "lg"}>{props.event.name}</Heading>}
                        <DataList.Root 
                                orientation={state.isMobile ? "vertical" : "horizontal"}
                                gap={state.isMobile ? 2 : 4}
                        >
                                <DataList.Item>
                                        <DataList.ItemLabel fontSize={state.isMobile ? "xs" : "sm"}>Location</DataList.ItemLabel>
                                        <DataList.ItemValue fontSize={state.isMobile ? "xs" : "sm"}>
                                                {props.event.city}, {props.event.state}
                                        </DataList.ItemValue>
                                </DataList.Item>
                                <DataList.Item>
                                        <DataList.ItemLabel fontSize={state.isMobile ? "xs" : "sm"}>Type</DataList.ItemLabel>
                                        <DataList.ItemValue fontSize={state.isMobile ? "xs" : "sm"} textTransform="capitalize">
                                                {props.event.type}
                                        </DataList.ItemValue>
                                </DataList.Item>
                                <DataList.Item>
                                        <DataList.ItemLabel fontSize={state.isMobile ? "xs" : "sm"}>Distances</DataList.ItemLabel>
                                        <DataList.ItemValue>
                                                <Wrap gap={1}>
                                ...
                                <DataList.Item>
                                        <DataList.ItemLabel fontSize={state.isMobile ? "xs" : "sm"}>Attending</DataList.ItemLabel>
                                        <DataList.ItemValue>
                                                <Wrap gap={1}>
                        ...
                        <Button asChild variant="ghost" size={state.isMobile ? "sm" : "md"}>
